...
import random
label_in=np.reshape(np.load("./groundtruth_cnn.npy"),[10,10,3,256,513,1]) #(300,128,257)
prediction_in=np.reshape(np.load("./output_cnn.npy"),[10,10,3,256,513,1]) #(5, 24, 5, 128, 257, 1),
label_in=skimage.measure.block_reduce(label_in, (1,1,1,2,2,1), np.max)
prediction_in=skimage.measure.block_reduce(prediction_in, (1,1,1,2,2,1), np.max)
